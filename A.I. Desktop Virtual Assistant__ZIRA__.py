...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
        ...
        elif 'open stack overflow python' and 'open stack overflow' and 'openstackoverflow' and 'openstack overflow' in query:
            ...
            print("Hi! I am ZIRA. Your A.I. virtual Desktop Assistant. How can i help you ?")
            speak("Hi! I am ZIRA. Your AI virtual desktop assistant. How can i help you ?")

        elif 'email' in query:
            try:
                print("What should i write in the email ?")
            ...
            print("Below is the information about your os...")
